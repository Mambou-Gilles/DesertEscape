...
public class GettingHelpView extends View {
    ...
    private void moveGame() {
        this.console.println("\n*****************************************************************"
                ...
                + "\n* a new menu in which you can select the differnt locations     *"
                + "\n* options to find the resources and save the earth.             *"
                + "\n*  The principals are:                                          *"
                + "\n*                                                               *"
    ...
    private void displayEstimatedResource() {
        this.console.println("\n********************************************************************"
                ...
                + "\n*                                                                  *"
                + "\n* Your voyage requires to control the inventory that you           *"
                + "\n* have or need carry with in order to win the game. You can        *"
                + "\n* obtain this information by selecting these options:              *"
                + "\n*                                                                  *"
                + "\n* INVENTORY MENU: you receive a new menu in which youcan select:   *"
